...
| Día | Actividad | Esfuerzo (TCs) | Story Points (SP) |
| :--- | :--- | :---: | :---: |
| **Día 1** | Pruebas de HU1 (Montos) y HU3 (Marcado de Sospecha). | 13 | 6 |
| **Día 2** | Pruebas de HU2 (Ubicación) y HU4 (Niveles de Riesgo). | 13 | 6 |
| **Total** | **Cobertura completa de reglas de detección y riesgo** | **26 TCs** | **12 SP** |
